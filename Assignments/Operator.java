class Operators {
    public static void main(String args[]) {
		...
		int SavingsPerMonth = 100;
		int TargetSavingsGoal = 1000;
		int MonthsTillGoal = ((TargetSavingsGoal - currentSavings )/SavingsPerMonth);
		System.out.println(MonthsTillGoal);
		Boolean HasGirlf = true;
		Boolean HasJob = false;
		Boolean HasMoney = false;
		if(HasGirlf == true){
			System.out.println("Success");
		}
		else if(HasJob || HasMoney) {
			System.out.println("You're almost there!");
		}
		else{
			System.out.println("You are living a proud single life!");
		}
