...
class Plinko {
    ...
    public static void printOddRow(int discPosition) {
        ...
        else if (discPosition == 3){
            System.out.println(" . . .0. . . . . ");
        }
        else if (discPosition == 5){
            System.out.println(" . . . . .0. . . ");
        }
        else if (discPosition == 7){
            System.out.println(" . . . . . . .0. ");
        }
    ...
    public static void printEvenRow(int discPosition) {
        ...
        else if (discPosition == 2){
            System.out.println(" . .0. . . . . . ");
        }
        else if (discPosition == 4){
            System.out.println(" . . . .0. . . . ");
        }
        else if (discPosition == 6){
            System.out.println(" . . . . . .0. . ");
        }
        else if (discPosition == 8){
            System.out.println(" . . . . . . . .0");
        }
    }
